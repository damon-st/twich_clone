...
import 'package:twich_clone/resources/log_sink.dart';
...
class _State extends State<JoinChannelAudio> {
  ...
  _joinChannel() async {
    ...
    await _engine
        .joinChannel(token, _controller.text, null, Random().nextInt(10))
        .catchError((onError) {
                        ...
                        Slider(
                          ...
                          onChanged: isJoined
                              ? (double value) {
                                  ...
                                  _engine.adjustRecordingSignalVolume(
                                      value.toInt());
                                }
                              : null,
                        )
